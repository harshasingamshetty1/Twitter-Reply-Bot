...
TWITTER_CONSUMER_API_KEY = os.getenv("TWITTER_CONSUMER_API_KEY", "YourKey")
TWITTER_CONSUMER_API_SECRET = os.getenv("TWITTER_CONSUMER_API_SECRET", "YourKey")

TWITTER_CLIENT_ID= os.getenv("TWITTER_CLIENT_ID", "YourKey")
TWITTER_CLIENT_SECRET=os.getenv("TWITTER_CLIENT_SECRET", "YourKey")
...
class TwitterBot:
    def __init__(self):
        ...
        # Initialize the language model w/ temperature of .1 to induce some creativity
        self.llm = ChatOpenAI(temperature=.1, openai_api_key=OPENAI_API_KEY, model_name='gpt-3.5-turbo')
